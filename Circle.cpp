...
void veiksmaisufailu() {
    ...
    if(failiukas!="0"){
        ...
        do{
            ...
            if (myfile) {
                ...
                cout << endl;
                cout << failiukas << " Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
                cout << "---------------------------------------------------------------- " << endl;
            }
            else {
   ...
   // do{ 
   //     cout << "rasykite bet koki simbolį, jei norite generuoti faila arba 0, jei nenorite testi." << endl;
   //     cin >> tikrinti; 
   //     if (tikrinti != "0") {
           // auto st = hrClock::now();
          //  auto end = hrClock::now();
   ...
   // veiksmaisufailu2(test);
    /*
            ...
            std::chrono::duration<double> difff = end - st; // Skirtumas (s)
            cout << endl;
            cout << "failas1000.txt" <<" Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
            cout << "---------------------------------------------------------------- " << endl;
            system("pause");
            ...
            difff = end - st; // Skirtumas (s)
            cout << endl;
            cout << "failas10000.txt" << " Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
            cout << "---------------------------------------------------------------- " << endl;
            system("pause");
    */ /*
            st = hrClock::now();
            ...
            difff = end - st; // Skirtumas (s)
            cout << endl;
            cout << "failas100000.txt" << " Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
            cout << "---------------------------------------------------------------- " << endl;
            system("pause");
    */ /*
            st = hrClock::now();
            ...
            difff = end - st; // Skirtumas (s)
            cout << endl;
            cout << "failas1000000.txt" << " Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
            cout << "---------------------------------------------------------------- " << endl;
            system("pause");
            ...
            difff = end - st; // Skirtumas (s)
            cout << endl;
            cout << "failas10000000.txt" << " Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
            cout << "---------------------------------------------------------------- " << endl;
            system("pause");
    */
          //  auto end = hrClock::now();
         //   std::chrono::duration<double> difff = end - st; // Skirtumas (s)
          //  cout << endl;
          // cout << test <<" Irasu, visas programos sugaištas laikas: " << difff.count() << " s\n\n";
          //  cout << "---------------------------------------------------------------- " << endl;
...
void eil_po_eil(std::string read_vardas, std::string write_vardas, vector<data>& sarasas) {
   ...
   // auto start = std::chrono::high_resolution_clock::now(); auto st = start;
    ...
    // diff = end - start; // Skirtumas (s)
    // std::cout << "Failo įrašymas eilutemis iš eilučių vektoriaus užtruko: " << diff.count() << " s\n";
    splited.resize(0);
    //sarasas.resize(0);
