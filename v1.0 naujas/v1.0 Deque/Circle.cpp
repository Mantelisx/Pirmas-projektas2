...
deque<data> skirtstykStudentus(deque<data>& studentai) {
    deque<data> kieti, minksti;
...
void pirmastrategija(deque<data> studentai, deque<data>& kieti, deque<data>& minksti) {
...
deque<data> antrastrategija(deque<data>& studentai) {
    deque<data> minksti;
    deque<data>::iterator it = studentai.begin();
...
void veiksmaisufailu2(string test) {
    ...
    */
     ...
     ofstream fiveormore("rez_fiveormore_deque" + test);
     ofstream lessthanfive("rez_lessthanfive_deque" + test);
     
    int paz=0;
    double vidurkis = 0;
    // vector<data> sarasas;

    deque<data> moreoreqfive;
    deque<data> lessfive;

    deque<data> studentas; // studentas dekas strategijoms 1
