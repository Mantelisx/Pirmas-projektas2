...
void pirmastrategija(list<data> studentai, list<data>& kieti, list<data>& minksti) {
...
list<data> antrastrategija(list<data>& studentai) {
    list<data> minksti;
    list<data>::iterator it = studentai.begin();
    ...
    return minksti; // gràşina studentus gavusius skolà
}
...
void veiksmaisufailu2(string test) {
    ...
    */
    ...
    list<data> studentas; // studentas listas strategijoms 1
